...
<h3 align="center">
Backend Software Engineer · Distributed Systems · Python · FastAPI · Django · AWS
</h3>

<p align="center">
  <a href="https://www.linkedin.com/in/shiladitya-majumder/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" />
  </a>
  <a href="mailto:shiladityamajumder07@gmail.com">
    <img src="https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white" />
  </a>
  <a href="https://github.com/shiladityamajumder">
...
Backend-focused Software Engineer with experience building **scalable, high-performance APIs and data-intensive systems** across healthcare, agri-tech, and e-commerce domains.

- Currently working at **SastaSundar**, developing backend systems for healthcare and commerce platforms
- Strong focus on **API design, data modeling, performance optimization, and system reliability**
- Experienced with **FastAPI, Django, PostgreSQL, Redis, AWS**
- Interested in **distributed systems, recommendation engines, and backend architecture**
...
- Improved API response times by **~45%** through query optimization and serializer refactoring
- Built scalable backend systems serving **5K+ active users** in agri-tech domain
- Designed secure **DICOM ingestion and NLP-based evaluation pipelines** for radiology platforms
...
- Developing **FastAPI-based backend services** for healthcare and e-commerce platforms
- Designing modular, high-performance APIs with strong data consistency guarantees
- Implementing **Redis-based caching** and background processing to reduce latency
- Collaborating closely with frontend and product teams for system integration

---

### **Centrelocus**, Remote  
**Backend Developer** · *Aug 2021 – Oct 2025*

- Built and maintained REST APIs for agri-tech and health-tech products
- Implemented features such as **geo-tracking, bidding systems, chat, and authentication**
- Worked on end-to-end backend delivery with PostgreSQL, AWS, and Django/FastAPI
- Collaborated with mobile and frontend teams in a distributed setup

**Tech Stack:** Django REST Framework, FastAPI, PostgreSQL, AWS, Redis, Git
...
- **Graph-Based Recommendation System**
  - Designed a recommendation engine using **Neo4j (Graph Database)**
  - Modeled users, items, and interactions as nodes and relationships
  - Implemented **collaborative filtering and traversal-based recommendations**
  - Wrote optimized **Cypher queries** for similarity scoring and ranking

- **FreshScan**
  - Backend platform for crop supply chain management and marketplace operations
  - Features include GPS mapping, inventory, and user workflows

- **LungX**
  - Audio-based lung diagnostics using signal processing and analysis pipelines

- **MotoSpar**
  - Multi-vendor vehicle parts inventory and order management system

- **Paper Trading Platform**
  - Simulated stock trading system with real-time data handling

- **Radiology Exam Portal**
  - Secure DICOM uploads, NLP-based scoring, and analytics dashboards

- **Government Chatbot**
  - Botpress-based chatbot for answering public queries from structured datasets
...
- AWS Machine Learning – Coursera (2024)  
...
## ✍️ Writing, Architecture & Open Source

I write about **real-world backend engineering**, focusing on architecture, scalability, and production trade-offs.
Most articles are based on **systems I’ve built or migrated in production**.
